...
public class Main {
    ...
    public static final MyGraph graph = new MyGraph("1.txt");
    ...
    // 展示有向图
    @SuppressWarnings({"checkstyle:Indentation", "checkstyle:ParameterName", "checkstyle:MissingJavadocMethod"})
    ...
    // 计算最短路径，考虑权重
    @SuppressWarnings({"checkstyle:Indentation", "checkstyle:VariableDeclarationUsageDistance", "checkstyle:MissingJavadocMethod", "checkstyle:LineLength"})
...
class MyGraph {
    ...
    @SuppressWarnings({"checkstyle:Indentation", "checkstyle:LineLength", "checkstyle:AbbreviationAsWordInName"})
